...
class printer:
    ...
    def setup(testcase,result,sreason,ereason,Section,sectionfailed,errored,blocked,abortreason,failedonly,pre,post,errorsection,ar,blocklist,blockreason,sectionfailedreasonreason,secretfailedreasons):
